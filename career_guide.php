...
/>
    ...
    <section id="hero-section" class="hero">
        <div class="container px-3 px-md-0">
            <h2>Black Girls in Tech</h2>
            <p>Looking for more information on how to start/transition into a field why not download one of our Career Guide PDF'S Below ?</p>
            <p>For additional advice, feel free to schedule a consultation call with one of our
            team members.
            </p>
        </div>
    </section>
    ...
    <!-- career guide cards -->
    <section id="career-guides">
        <div class="container">
            <div class="row">
                <!-- Single Career Guide card -->
                <div class="col-lg-4">
                    <div class="card" style="width: 18rem;">
                        <img src="images/headshot.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                          <h5 class="card-title">Course title <span class="float-end text-success">20% Off</span></h5>
